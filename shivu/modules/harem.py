...
async def mywaifus(update: Update, context: CallbackContext, page=0) -> None:
    ...
    level = (
        ...
        "👑 Ultimate Waifu King" if power_level <= 300 else
    ...
    keyboard = [[InlineKeyboardButton(f"📜 See Full Collection ({total_count})", switch_inline_query_current_chat=f"collection.{user_id}")]]
