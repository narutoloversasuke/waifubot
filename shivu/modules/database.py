...
UPLOAD_HANDLER = CommandHandler('daaldo', upload, block=False)
application.add_handler(UPLOAD_HANDLER)
DELETE_HANDLER = CommandHandler('delet784848e', delete, block=False)
application.add_handler(DELETE_HANDLER)
UPDATE_HANDLER = CommandHandler('updat74774747e', update, block=False)
