class Config(object):
    ...
    TOKEN = "7656541596:AAEkC5jxXlArTehwTS9"  # Updated Token
    mongo_url = "mongodb+srv://naruhina:@cluster0.03pl6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0" 
